...
// auto protocol = Radio::LinkLayerConfig{1, GATAS::Modulation::GFSK, GATAS::DataSource::FLARM, 24 + 2, 1*8, 7, {0x55, 0x99, 0xA5, 0xA9, 0x55, 0x66, 0x65, 0x96}}; // 0 FLARM 0 airtime 6ms
